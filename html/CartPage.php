      ...
      <div class="cart-items-container">
        <article class="cart-item">
            <div class="item-labels"> 
                <p class="label-product">Product</p> 
                <div class="label-info"> 
                    <p class="item-quantity">Total Price</p> 
                    <p class="item-total">Quantity</p> 
                </div> 
            </div>
            <div class="item-details-container">
              <div class="item-details"> 
                <div class="product-info"> 
                  <img src="../assets/standard-wheelchair.png" alt="Standard Wheelchair" class="product-img"> 
                  <p class="product-name">809 Standard <br> Wheelchair</p> 
                </div> 
        ...
        <article class="summary-section">
            <div class="summary-container">
                ...
                <p class="summary-total">Subtotal <span class="subtotal-amount">₱ 4,000</span></p>
                <a href="../html/CheckoutPage.php"><button class="checkout-btn">PROCEED TO CHECKOUT</button></a>
            </div>
        </article>
    </div>
  </main>
