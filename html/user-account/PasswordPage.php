...
<head>
  ...
  <link rel="stylesheet" href="../../css/user-account/PasswordPage.css">
    ...
    <section class="account-container">
      <article class="account-navigation">
        ...
        <div class="account-options">
          ...
          <a href="" class="account-option password">Password</a>
          <a href="../../html/user-account/PurchasePage.php" class="account-option">My Purchase</a>
      ...
      <article class="account-information">
        ...
        <div class="account-section-three">
          <h1>
            Edit your password
          </h1>
        </div>
        ...
        <div class="account-section-four">
          <input type="password" name="old-password" id="old-password" placeholder="Current Password" class="account-password" required>
          <input type="password" name="new-password" id="new-password" placeholder="New Password" class="account-password" required>
          <input type="password" name="confirm-password" id="confirm-password" placeholder="Confirm Password" class="account-password" required>
        </div>
