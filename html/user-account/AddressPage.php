...
<head>
  ...
  <link rel="stylesheet" href="../../css/user-account/AddressPage.css">
    ...
    <section class="account-container">
      <article class="account-navigation">
        ...
        <div class="account-options">
          ...
          <a href="" class="account-option address">Addresses</a>
          <a href="../../html/user-account/PasswordPage.php" class="account-option">Password</a>
        ...
        <div class="account-section-four">
          <article class="Home">
            <div class="radio-container">
              <input type="radio" name="location" id="home" class="radio-input" style="height:20px; width:20px; margin-top: 1.8px;">
              <label for="home" class="radio-label">Home</label>
            </div>
            <div class="address-container">
              <p class="address-label">
                Ph 10 Blk 4 Lot 67 Centella <br>
                Homes Subdivision San Isidro <br>
                Rodriguez Rizal
              </p>
          ...
          <article class="Work">
            <div class="radio-container">
              <input type="radio" name="location" id="home" class="radio-input" style="height:20px; width:20px; margin-top: 1.8px;">
              <label for="home" class="radio-label">Work</label>
            </div>
            <div class="address-container">
              <p class="address-label">
                Ph 10 Blk 4 Lot 67 Centella <br>
